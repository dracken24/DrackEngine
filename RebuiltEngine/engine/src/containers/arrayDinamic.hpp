...
#define darray_push(array, value)                                                            \
    {                                                                                        \
        ...
        array = static_cast<const char **>(_darray_push(static_cast<void *>(array), &temp)); \
    }

#define darray_push_event(array, value)                                                           \
    {                                                                                             \
        decltype(value) temp = value;                                                             \
        array = static_cast<registered_event *>(_darray_push(static_cast<void *>(array), &temp)); \
    }
